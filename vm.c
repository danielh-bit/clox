...
void initVM() {
    ...
    vm.initString = NULL; // covers gc bug
    ...
    if (IS_OBJ(callee)) {
        switch (OBJ_TYPE(callee)) {
            case OBJ_BOUND_METHOD: {
                ...
                vm.stackTop[-argCount - 1] = bound->reciever; // the reciever will be stored on slot 0 on the stack.
            ...
            case OBJ_CLASS: {
                ...
                } else if (argCount != 0) { // if no costume init method found, report error when provided arguments.
    ...
    for (;;) {
        ...
        switch(instruction = READ_BYTE()) {
            ...
            case OP_INHERIT: {
                ...
                // this still allows for method overrides because the methods are compiled after this instruction.
